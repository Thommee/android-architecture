...
public class RepositoryAdapter extends RecyclerView.Adapter<RepositoryAdapter.RepositoryViewHolder> {
    ...
    public void setRepositories(List<RepositoryViewModel> repositories) {
